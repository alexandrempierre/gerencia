...
public class ObjectClassLdap {
  ...
  public static final String[] EMPLOYEE_OBJECT_CLASS = new String[] {"dcc","inetOrgPerson","posixAccount","shadowAccount","sambaSamAccount","person","organizationalPerson","top"};
